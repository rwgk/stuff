...
int str2date (string, day, month, year)
char string[];
int  *day, *month, *year;
{
  int i, c, nfld, errorf;
...
long lin2date (lin, day, month, year)
long lin;
int  *day, *month, *year;
{
  long il;

  *year = lin / 36524.25; lin -= (long) (*year * 36524.25);
  il = lin / 365.25; lin -= (long) (il * 365.25);
